...
csvtojson({
    ...
    .then((jsonObj) => {
        ...
        //generate menu program basic
        let mbasicOutput = fs.readFileSync(assetDir + 'basic/!MENU.bas', 'utf-8');

        //create DATA statements for games list
        let mbasicLineNumber = 810;
        let mdataChunk = "";
        let mdataBit = "";
        ...
        compilationData.forEach(pubData => {
            mdataBit = "DATA " + pubData.publisher + "," + pubData.filename + "," + pubData.diskNumber + "," + pubData.diskSide;
